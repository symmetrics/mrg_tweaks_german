...
Das Modul Symmetrics_DefaultAddressSelection aktiviert stattdessen die Option
...
Javascript Datei eingebunden, die das select Feld im Checkout
("An diese Adresse verschicken") ändert.

F: 1. Ein Beispiel-Link wird durch das Modul Symmetrics_ConfigGermanTexts installiert.
...
F: Wenn Sie unterschiedliche Mehrwertsteuersätze abhängig von Kundengruppen
   verwenden, kann die Anzeige des Mehrwertsteuersatzes fuer ein Produkt unkorrekt sein.
...
*** B: 1. Ins Front-End gehen und ein Artikel in den Warenkob liegen. Auf der 
...
*** C: 1. Ins Front-End gehen und einen Artikel in den Warenkob liegen. Auf der 
